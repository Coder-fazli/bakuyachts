...
WordPress version: required at least 5.0, tested up to 6.5.2
...
Please install and activate it before starting to use the theme Yacht Rental.
...
Theme documentation is available on https://doc.themerex.net/yacht-rental/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Yacht Rental is Fontello.
