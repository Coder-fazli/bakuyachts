...
if ( ! function_exists( 'yacht_rental_trx_addons_get_css' ) ) {
	add_filter( 'yacht_rental_filter_get_css', 'yacht_rental_trx_addons_get_css', 10, 2 );
	function yacht_rental_trx_addons_get_css( $css, $args ) {
