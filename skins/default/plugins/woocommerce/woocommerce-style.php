...
if ( ! function_exists( 'yacht_rental_woocommerce_get_css' ) ) {
	add_filter( 'yacht_rental_filter_get_css', 'yacht_rental_woocommerce_get_css', 10, 2 );
	function yacht_rental_woocommerce_get_css( $css, $args ) {
...
$fdir = yacht_rental_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
