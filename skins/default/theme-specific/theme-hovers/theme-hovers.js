	...
	'action.init_hidden_elements', function(e, cont) {
		...
		if (YACHT_RENTAL_STORAGE['button_hover'] && YACHT_RENTAL_STORAGE['button_hover'] != 'default') {
			jQuery(
				...
				// Theme tabs
				+ '.yacht_rental_tabs .yacht_rental_tabs_titles li a:not([class*="sc_button_hover_"]),'
				// More link
			...
			).addClass( 'sc_button_hover_just_init sc_button_hover_' + YACHT_RENTAL_STORAGE['button_hover'] );
			...
			jQuery(
				...
				// Theme tabs
				+ '.yacht_rental_tabs .yacht_rental_tabs_titles li a:not([class*="sc_button_hover_style_"]),'
				// Tag cloud
			...
			).removeClass( 'sc_button_hover_' + YACHT_RENTAL_STORAGE['button_hover'] );
