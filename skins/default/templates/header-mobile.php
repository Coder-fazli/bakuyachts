		...
		<div class="columns_wrap columns_fluid">
			<div class="sc_layouts_column sc_layouts_column_align_left sc_layouts_column_icons_position_left sc_layouts_column_fluid column-1_3">
				...
				if ( yacht_rental_exists_trx_addons() ) {
					...
					if ( yacht_rental_is_off( yacht_rental_get_theme_option( 'header_mobile_hide_login' ) ) ) {
						ob_start();
						do_action(
							'yacht_rental_action_login', array(
								'text_login'  => false,
								'text_logout' => false,
							)
						);
					...
					// Display cart button
					if ( yacht_rental_is_off( yacht_rental_get_theme_option( 'header_mobile_hide_cart' ) ) ) {
						ob_start();
					...
					if ( yacht_rental_is_off( yacht_rental_get_theme_option( 'header_mobile_hide_search' ) ) ) {
						ob_start();
						do_action(
