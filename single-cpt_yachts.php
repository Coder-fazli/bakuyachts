...
// Button titles (with defaults)
$whatsapp_btn_text = get_post_meta(get_the_ID(), '_yr_yacht_whatsapp_btn_text', true);
$contact_btn_text = get_post_meta(get_the_ID(), '_yr_yacht_contact_btn_text', true);
if (empty($whatsapp_btn_text)) $whatsapp_btn_text = __('WHATSAPP US', 'yacht-rental');
if (empty($contact_btn_text)) $contact_btn_text = __('GET IN TOUCH', 'yacht-rental');
...
$features_title = get_post_meta(get_the_ID(), '_yr_yacht_features_title', true);
$offers_title = get_post_meta(get_the_ID(), '_yr_yacht_offers_title', true);
$faq_title = get_post_meta(get_the_ID(), '_yr_yacht_faq_title', true);

if (empty($features_title)) $features_title = __('Key Features of', 'yacht-rental') . ' ' . get_the_title();
if (empty($offers_title)) $offers_title = __('We also Offer:', 'yacht-rental');
if (empty($faq_title)) $faq_title = __('Frequently Asked Questions', 'yacht-rental');
?>
<!DOCTYPE html>
...
<style>
    ...
    .yrsp-yacht-container {
        ...
        padding: 31px 20px 40px 20px !important;
...
<div class="yrsp-yacht-container">
    ...
    <div class="yrsp-faq-section">
        <h2 class="yrsp-faq-title"><?php echo esc_html($faq_title); ?></h2>
