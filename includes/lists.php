...
if ( ! function_exists('yacht_rental_get_not_selected_text') ) {
	/**
	 ...
	 */
	function yacht_rental_get_not_selected_text( $label ) {
		return apply_filters( 'yacht_rental_filter_not_selected_text',
								sprintf( apply_filters( 'yacht_rental_filter_not_selected_mask', __( '- %s -', 'yacht-rental' ) ), $label )
							);
	}
}

if ( ! function_exists( 'yacht_rental_get_list_range' ) ) {
	/**
	 ...
	 */
	function yacht_rental_get_list_range( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			$list[ $i ] = $i;
		}
...
if ( ! function_exists( 'yacht_rental_get_list_checkbox_values' ) ) {
	/**
	 ...
	 * @return array                 An associative array with 'yes' and 'no' elements.
	 */
	function yacht_rental_get_list_checkbox_values( $prepend_inherit = false ) {
		$list = apply_filters(
			'yacht_rental_filter_list_checkbox_values', array(
				1         => esc_html__( 'Yes', 'yacht-rental' ),
				0         => esc_html__( 'No', 'yacht-rental' ),
			)
		);
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'yacht_rental_get_list_visiblehidden' ) ) {
	/**
	 ...
	 */
	function yacht_rental_get_list_visiblehidden( $prepend_inherit = false ) {
		$list = array(
			'visible' => esc_html__( 'Visible', 'yacht-rental' ),
			'hidden'  => esc_html__( 'Hidden', 'yacht-rental' ),
		);
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'yacht_rental_get_list_paddings' ) ) {
	/**
	 ...
	 */
	function yacht_rental_get_list_paddings( $prepend_inherit = false ) {
		$list = apply_filters(
			'yacht_rental_filter_list_paddings', array(
				'none'  => array(
							'title' => esc_html__( 'No Padding', 'yacht-rental' ),
							'icon'  => 'images/theme-options/section-padding/none.png',
						),
				'small'  => array(
							'title' => esc_html__( 'Small Padding', 'yacht-rental' ),
							'icon'  => 'images/theme-options/section-padding/small.png',
						),
				'medium' => array(
							'title' => esc_html__( 'Medium Padding', 'yacht-rental' ),
							'icon'  => 'images/theme-options/section-padding/medium.png',
						),
				'large' => array(
							'title' => esc_html__( 'Large Padding', 'yacht-rental' ),
...
if ( ! function_exists( 'yacht_rental_get_list_hovers' ) ) {
	...
	function yacht_rental_get_list_hovers( $prepend_inherit = false ) {
		$list = apply_filters(
			'yacht_rental_filter_list_hovers', array(
				'dots'    => esc_html__( 'Dots', 'yacht-rental' ),
				'icon'    => esc_html__( 'Icon', 'yacht-rental' ),
				'icons'   => esc_html__( 'Icons', 'yacht-rental' ),
				'zoom'    => esc_html__( 'Zoom', 'yacht-rental' ),
				'fade'    => esc_html__( 'Fade', 'yacht-rental' ),
				'slide'   => esc_html__( 'Slide', 'yacht-rental' ),
				'pull'    => esc_html__( 'Pull', 'yacht-rental' ),
				'border'  => esc_html__( 'Border', 'yacht-rental' ),
				'excerpt' => esc_html__( 'Excerpt', 'yacht-rental' ),
				'info'    => esc_html__( 'Info', 'yacht-rental' ),
			)
		);
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'yacht_rental_get_list_blog_contents' ) ) {
	/**
	 ...
	 */
	function yacht_rental_get_list_blog_contents( $prepend_inherit = false ) {
		$list = array(
				'excerpt'  => esc_html__( 'Excerpt', 'yacht-rental' ),
				'fullpost' => esc_html__( 'Full post', 'yacht-rental' ),
		);
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'yacht_rental_get_list_blog_paginations' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function yacht_rental_get_list_blog_paginations( $prepend_inherit = false ) {
		$list = array(
					'pages'    => array(
					...
					'links'    => array(
										'title' => esc_html__( 'Older/Newest', 'yacht-rental' ),
...
if ( ! function_exists( 'yacht_rental_get_list_sidebars' ) ) {
	 ...
	 */
	function yacht_rental_get_list_sidebars( $prepend_inherit = false, $add_hide = false ) {
		$list = yacht_rental_storage_get( 'list_sidebars' );
		if ( '' == $list ) {
			...
			yacht_rental_storage_set( 'list_sidebars', $list );
		}
		if ( $add_hide ) {
			$list = yacht_rental_array_merge( array( 'hide' => yacht_rental_get_not_selected_text( esc_html__( 'Select widgets', 'yacht-rental' ) ) ), $list );
		}
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'yacht_rental_get_list_sidebars_positions' ) ) {
	...
	function yacht_rental_get_list_sidebars_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'yacht_rental_filter_list_sidebars_positions', array(
				'hide'  => array(
							'title' => esc_html__( 'No sidebar', 'yacht-rental' ),
							'icon'  => 'images/theme-options/sidebar-position/hide.png',
						),
				'left'  => array(
							'title' => esc_html__( 'Left sidebar', 'yacht-rental' ),
							'icon'  => 'images/theme-options/sidebar-position/left.png',
						),
				'right' => array(
							'title' => esc_html__( 'Right sidebar', 'yacht-rental' ),
...
if ( ! function_exists( 'yacht_rental_get_list_sidebars_positions_ss' ) ) {
	/**
	 ...
	 */
	function yacht_rental_get_list_sidebars_positions_ss( $prepend_inherit = false ) {
		$list = apply_filters(
			'yacht_rental_filter_list_sidebars_positions_ss', array(
				'above' => esc_html__( 'Above the content', 'yacht-rental' ),
				'below' => esc_html__( 'Below the content', 'yacht-rental' ),
				'float' => esc_html__( 'Floating bar', 'yacht-rental' ),
			)
		);
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'yacht_rental_get_list_sidebar_styles' ) ) {
	/**
	 ...
	 */
	function yacht_rental_get_list_sidebar_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'yacht_rental_filter_list_sidebar_styles', array() );
		}
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'yacht_rental_get_list_header_footer_types' ) ) {
	/**
	 ...
	 */
	function yacht_rental_get_list_header_footer_types( $prepend_inherit = false ) {
		$list = apply_filters(
			'yacht_rental_filter_list_header_footer_types', array(
...
if ( ! function_exists( 'yacht_rental_get_list_header_styles' ) ) {
	/**
	 ...
	 */
	function yacht_rental_get_list_header_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'yacht_rental_filter_list_header_styles', array() );
		}
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'yacht_rental_get_list_header_positions' ) ) {
	/**
	 ...
	 */
	function yacht_rental_get_list_header_positions( $prepend_inherit = false ) {
		$list = apply_filters( 'yacht_rental_filter_list_header_positions', array(
			'default' => esc_html__( 'Default', 'yacht-rental' ),
			'over'    => esc_html__( 'Over', 'yacht-rental' ),
			'under'   => esc_html__( 'Under', 'yacht-rental' ),
		) );
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'yacht_rental_get_list_footer_styles' ) ) {
	/**
	 ...
	 */
	function yacht_rental_get_list_footer_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'yacht_rental_filter_list_footer_styles', array() );
		}
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'yacht_rental_get_list_body_styles' ) ) {
	 ...
	 *                                This format used to show elements in the 'icons' style instead dropdown.
	 */
	function yacht_rental_get_list_body_styles( $prepend_inherit = false, $force_fullscreen = false ) {
		$list = array(
			'boxed' => array(
						'title' => esc_html__( 'Boxed', 'yacht-rental' ),
						'icon'  => 'images/theme-options/body-style/boxed.png',
					),
			'wide'  => array(
						'title' => esc_html__( 'Wide', 'yacht-rental' ),
						'icon'  => 'images/theme-options/body-style/wide.png',
					),
		);
		if ( apply_filters( 'yacht_rental_filter_allow_fullscreen', $force_fullscreen || yacht_rental_get_theme_setting( 'allow_fullscreen' ) || yacht_rental_get_edited_post_type() == 'page' ) ) {
			if ( yacht_rental_get_theme_setting( 'allow_fullwide', true ) ) {
				$list['fullwide']   = array(
										'title' => esc_html__( 'Fullwidth', 'yacht-rental' ),
										'icon'  => 'images/theme-options/body-style/fullwide.png',
										);
			}
			$list['fullscreen'] = array(
									'title' => esc_html__( 'Fullscreen', 'yacht-rental' ),
...
if ( ! function_exists( 'yacht_rental_get_list_expand_content' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function yacht_rental_get_list_expand_content( $prepend_inherit = false, $narrow = false ) {
		$list = apply_filters(
			'yacht_rental_filter_list_expand_content', array_merge(
				( $narrow
					? array(
						'narrow' => array(
								'title' => esc_html__( 'Narrow', 'yacht-rental' ),
				...
				array(
					'normal' => array(
							'title' => esc_html__( 'Normal', 'yacht-rental' ),
...
if ( ! function_exists( 'yacht_rental_get_list_remove_margins' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function yacht_rental_get_list_remove_margins( $prepend_inherit = false ) {
		$list = apply_filters(
			'yacht_rental_filter_list_remove_margins', array(
				'0'  => array(
							'title' => esc_html__( 'Margins On', 'yacht-rental' ),
							'icon'  => 'images/theme-options/remove-margins/on.png',
						),
				'1'  => array(
							'title' => esc_html__( 'Margins Off', 'yacht-rental' ),
...
if ( ! function_exists( 'yacht_rental_get_list_meta_parts' ) ) {
	/**
	 ...
	 */
	function yacht_rental_get_list_meta_parts( $prepend_inherit = false ) {
		$list = apply_filters(
			'yacht_rental_filter_list_meta_parts',
			array(
				'author'     => esc_html__( 'Post author', 'yacht-rental' ),
				'date'       => esc_html__( 'Published date', 'yacht-rental' ),
				'modified'   => esc_html__( 'Modified date', 'yacht-rental' ),
				'views'      => esc_html__( 'Views', 'yacht-rental' ),
				'likes'      => esc_html__( 'Likes', 'yacht-rental' ),
				'comments'   => esc_html__( 'Comments', 'yacht-rental' ),
				'share'      => esc_html__( 'Share links', 'yacht-rental' ),
				'categories' => esc_html__( 'Categories', 'yacht-rental' ),
				'edit'       => esc_html__( 'Edit link', 'yacht-rental' ),
			)
		);
...
if ( ! function_exists( 'yacht_rental_get_list_share_links_positions' ) ) {
	/**
	 ...
	 */
	function yacht_rental_get_list_share_links_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'yacht_rental_filter_list_share_links_positions',
			array(
...
if ( ! function_exists( 'yacht_rental_get_list_blog_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function yacht_rental_get_list_blog_styles( $prepend_inherit = false, $filter = 'arh', $need_custom = true ) {
		$list   = array();
					...
					if ( 'arh' == $filter && isset( $v['columns'] ) && is_array( $v['columns'] ) ) {
						...
						foreach ( $v['columns'] as $col ) {
							...
							$list[ "{$k}_{$col}" ] = 'arh' == $filter
														? array(
															'title'   => sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'yacht-rental' ), $v['title'], $col ),
															'icon'    => ! empty( $v['icon'] )
																			? ( strpos( $v['icon'], '%d' ) !== false ? sprintf( $v['icon'], $col ) : $v['icon'] )
																			: 'images/theme-options/blog-style/custom.png',
															'new_row' => $new_row,
															)
														: sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'yacht-rental' ), $v['title'], $col );
							$new_row = false;
						}
					} else {
						$list[ $k ] = 'arh' == $filter
		...
		$list = apply_filters( 'yacht_rental_filter_list_blog_styles', $list, $filter, $need_custom );
		return $prepend_inherit
					? yacht_rental_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'yacht_rental_get_list_single_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function yacht_rental_get_list_single_styles( $prepend_inherit = false ) {
		$list = apply_filters( 'yacht_rental_filter_list_single_styles', yacht_rental_storage_get( 'single_styles' ) );
		return $prepend_inherit
					? yacht_rental_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'yacht_rental_get_list_categories' ) ) {
	...
	function yacht_rental_get_list_categories( $prepend_inherit = false ) {
		$list = yacht_rental_storage_get( 'list_categories' );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					$list[ $cat->term_id ] = apply_filters( 'yacht_rental_filter_term_name', $cat->name, $cat );
				}
			}
			yacht_rental_storage_set( 'list_categories', $list );
		}
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'yacht_rental_get_list_terms' ) ) {
	...
	function yacht_rental_get_list_terms( $prepend_inherit = false, $taxonomy = 'category' ) {
		$list = yacht_rental_storage_get( 'list_taxonomies_' . ( $taxonomy ) );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					...
					$list[ $cat->term_id ] = apply_filters( 'yacht_rental_filter_term_name', $cat->name . ( false && 'category' != $taxonomy ? " /{$cat->taxonomy}/" : '' ), $cat );
				}
			}
			yacht_rental_storage_set( 'list_taxonomies_' . ( $taxonomy ), $list );
		}
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'yacht_rental_get_list_posts_types' ) ) {
	...
	function yacht_rental_get_list_posts_types( $prepend_inherit = false ) {
		$list = yacht_rental_storage_get( 'list_posts_types' );
		if ( '' == $list ) {
			$list = apply_filters(
				'yacht_rental_filter_list_posts_types', array(
					'post' => esc_html__( 'Post', 'yacht-rental' ),
				)
			);
			yacht_rental_storage_set( 'list_posts_types', $list );
		}
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'yacht_rental_get_list_posts' ) ) {
	...
	function yacht_rental_get_list_posts( $prepend_inherit = false, $opt = array() ) {
		...
		$list = yacht_rental_storage_get( $hash );
		if ( '' == $list ) {
			$list = array();
			if ( false !== $opt['not_selected'] ) {
				$list['none'] = true === $opt['not_selected'] ? yacht_rental_get_not_selected_text( esc_html__( 'Not selected', 'yacht-rental' ) ) : $opt['not_selected'];
			}
			$args = array(
			...
			yacht_rental_storage_set( $hash, $list );
		}
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'yacht_rental_get_list_users' ) ) {
	...
	function yacht_rental_get_list_users( $prepend_inherit = false, $roles = array( 'administrator', 'editor', 'author', 'contributor', 'shop_manager' ) ) {
		$list = yacht_rental_storage_get( 'list_users' );
		if ( '' == $list ) {
			$list         = array();
			$list['none'] = yacht_rental_get_not_selected_text( esc_html__( 'Not selected', 'yacht-rental' ) );
			$users        = get_users(
				array(
			...
			yacht_rental_storage_set( 'list_users', $list );
		}
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'yacht_rental_get_list_menus' ) ) {
	...
	function yacht_rental_get_list_menus( $prepend_inherit = false ) {
		$list = yacht_rental_storage_get( 'list_menus' );
		if ( '' == $list ) {
			$list            = array();
			...
			yacht_rental_storage_set( 'list_menus', $list );
		}
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
}
...
if ( ! function_exists( 'yacht_rental_get_list_icons' ) ) {
	 ...
	 */
	function yacht_rental_get_list_icons( $style = 'icons', $prepend_inherit = false ) {
		$lists = get_transient( 'yacht_rental_list_icons' );
		if ( ! is_array( $lists ) || ! isset( $lists[ $style ] ) || ! is_array( $lists[ $style ] ) || count( $lists[ $style ] ) < 2 ) {
			$lists = array();
			if ( 'icons' == $style ) {
				$lists[ $style ] = yacht_rental_array_from_list( yacht_rental_get_list_icons_classes( $prepend_inherit ) );
			} elseif ( 'images' == $style ) {
				$lists[ $style ] = yacht_rental_get_list_images();
			} else { // 'svg'
				$lists[ $style ] = yacht_rental_get_list_images( false, 'svg' );
			}
			if ( is_admin() && is_array( $lists[ $style ] ) && count( $lists[ $style ] ) > 1 ) {
				set_transient( 'yacht_rental_list_icons', $lists, 6 * 60 * 60 );       // Store to the cache for 6 hours
			}
		}
		return $lists[ $style ];
	}
...
if ( ! function_exists( 'yacht_rental_get_list_icons_classes' ) ) {
	/**
	 ...
	 * @return array                  An associative array with icons.
	 */
	function yacht_rental_get_list_icons_classes( $prepend_inherit = false ) {
		static $list = false;
		if ( ! is_array( $list ) ) {
			$list = ! is_admin() ? array() : yacht_rental_parse_icons_classes( yacht_rental_get_file_dir( 'css/font-icons/css/fontello-codes.css' ) );
		}
		$list = ! is_array( $list ) ? array() : yacht_rental_array_merge( array( 'none' => 'none' ), $list );
		return $prepend_inherit ? yacht_rental_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'yacht-rental' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'yacht_rental_get_list_images' ) ) {
	/**
	 ...
	 */
	function yacht_rental_get_list_images( $prepend_inherit = false, $type = 'png' ) {
...
if ( ! function_exists( 'yacht_rental_get_list_sc_color_styles' ) ) {
	/**
	 ...
	 */
	function yacht_rental_get_list_sc_color_styles( $prepend_inherit = false ) {
		$list = apply_filters(
			'yacht_rental_filter_get_list_sc_color_styles', array(
				'default' => esc_html__( 'Default', 'yacht-rental' ),
				'link2'   => esc_html__( 'Accent 2', 'yacht-rental' ),
				'link3'   => esc_html__( 'Accent 3', 'yacht-rental' ),
